    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        this.searchText = ((EditText) hasViews.findViewById(R.id.search_text));
        View view_search_button = hasViews.findViewById(R.id.search_button);

        if (view_search_button!= null) {
            view_search_button.setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View view) {
                    SearchActivity_.this.onSearchButtonPressed();
                }
            }
            );
        }
